...
<div class='container d-flex justify-content-center align-items-center mt-5'>
    <div class="card" style='min-width: 350px; max-width: 400px; background-color: #e60202'>
        <div class="card-body">
            @if(isset($status))
                @if ($status == 'success')
            ...
            <form method="post" action="">
                ...
                <div class="form-group">
                    <label for="number" class="d-flex justify-content-center align-content-center">
                    ...
                    <div class="alert alert-success">Your Transaction Reference: {{ $transactionReference }}</div>
                    <input type="hidden" name="transactionReference" value="{{ $transactionReference }}">
                    <input type="hidden" name="conversationReference" value="{{ $transactionReference }}">
                </div>
                <button type="submit" class="btn btn-success btn-block">I hereby confirm that I approved the payment</button>
            </form>
        </div>
    </div>
</div>
