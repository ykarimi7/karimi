...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Artists ({{ $artists->total() }})</li>
    </ol>
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 border-0">
                    ...
                    <a href="{{ route('backend.artists.add') }}" class="btn btn-primary btn-sm float-right">Add new artist</a>
                </div>
                        ...
                        <div id="collapseOne" class="collapse p-4" aria-labelledby="headingOne" data-parent="#collapseMetaTags">
                            <form class="search-form" action="{{ route('backend.artists') }}">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="term" class="form-control" placeholder="Artist nane..." value="{{ request()->input('term') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <a href="{{ route('backend.artists') }}" class="btn btn-secondary">Clear</a>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <form id="mass-action-form" method="post" action="{{ route('backend.artists.mass.action') }}">
                ...
                <table class="table table-striped datatables table-hover">
                    ...
                    <tr>
                        ...
                        <th>Name</th>
                        <th class="text-danger">Band Manager</th>
                    ...
                    <tbody>
                    @include('backend.commons.artist', ['artists' => $artists])
                    </tbody>
                </table>
                <div class="row">
                    <div class="col-6">{{ $artists->appends(request()->input())->links() }}</div>
                    <div class="col-6">
