    ...
    <div id="page-content" class="artist">
        <div class="container">
            <div class="page-header artist main small desktop">
                <a class="img">
                    <img id="page-cover-art" src="{{ $artist->artwork_url }}" alt="{!! $artist->name !!}">
                </a>
                <div class="inner">
            ...
            <div id="column1" class="content full">
                @if(count($artist->podcasts))
                    ...
                    <div id="grid" class="no-artist-column albums grid-albums-vertical items-sort-able">
                        @include('commons.podcast', ['podcasts' => $artist->podcasts, 'element' => 'grid'])
                    </div>
                @else
                    <div class="empty-page followers">
                        <div class="empty-inner">
                            <h2>{{ __('web.EMPTY_ALBUMS') }}</h2>
                        </div>
                    </div>
                @endif
            </div>
