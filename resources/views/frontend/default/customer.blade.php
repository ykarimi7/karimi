                ...
                {{csrf_field()}}
                   ...
                   <div class="row">
                       ...
                       <div class="  form-group  col-lg-2 col-6 ">
                            ...
                            <input type="date" name="date1" class="form-control"  id="exampleInputEmail1" placeholder="date1">
                        </div>
                       <div class=" form-group  col-lg-2 col-6 ">

                            <label  for="exampleInputEmail1">Date2</label>
                            <input type="date" name="date2" class="form-control"  id="exampleInputEmail1" placeholder="date1">
