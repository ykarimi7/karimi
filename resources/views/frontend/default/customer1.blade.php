    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 border-0">
                    <span style="font-weight: bold">Toplam lisans</span> <span style=" color: #31b916; font-weight: bolder">{{$usercount}}</span>                       <span style="font-weight: bold; margin-left: 10%;">Kullanılan lisans</span> <span style="color: #6a1414; font-weight: bolder">{{$count}}</span>
                    <span style="font-weight: bold; margin-left: 10%;">Kalan lisans</span> <span style="color:#800a0a; font-weight: bolder">{{$usercount-$count}}</span>
            ...
            <form   method="post" action="{{url('/newsearch')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="  form-group  col-lg-2 col-6 ">
                        ...
                        <input type="date" name="date1" class="form-control"  value="{{$d1}}"  id="exampleInputEmail1" placeholder="date1">
                    </div>
                    <div class=" form-group  col-lg-2 col-6 ">

                        <label  for="exampleInputEmail1">Date2</label>
                        <input type="date" name="date2" class="form-control" value="{{$d2}}"  id="exampleInputEmail1" placeholder="date1">

                    </div>
                    <div class="col-lg-2 col-6 ">
                        <button style="margin-top: 25px;"  class="btn btn-primary " type="submit">Ara
                            <div id="button-spinner" style="margin-left: 10px; width: 15px; height: 15px; display: none" class=""></div>
                        </button>
                    </div>
            ...
            <table class="table table-striped datatables table-hover">
                ...
                <tr>
                    ...
                    <th class="desktop">Çevrimiçi zaman</th>
                ...
                @foreach($var as $var)
                        <?php
                          $userinfo=\App\Models\User::where('id','=',$var->user_id)
                           ...
                           if($userinfo)
                                ...
                                <tr>
                                    ...
                                    <td style="align-content: center">{{$time}}{{' Gün'}}</td>

                                    <td style="align-content: center">{{$lastvizit}}</td>
                                    <td> <a style="color: #800a0a"   href="{{url('/del'.$userinfo->id)}}"  onclick="return confirm('are you sure?')">
