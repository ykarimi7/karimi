...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            ...
            <form method="post" action="{{ url('/newsearch') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="  form-group  col-lg-2 col-6 ">
                        ...
                        <input type="date" name="date1" class="form-control" value="{{ $d1 }}"
                            id="exampleInputEmail1" placeholder="date1">
                    </div>
                    <div class=" form-group  col-lg-2 col-6 ">

                        <label for="exampleInputEmail1">Date2</label>
                        <input type="date" name="date2" class="form-control" value="{{ $d2 }}"
                            id="exampleInputEmail1" placeholder="date1">
            ...
            <form method="POST" action="{{ url('exportPdf') }}" style="display: contents;">
                @csrf
                <input type="date" style="display: none" name="date1" class="form-control" value="{{ $d1 }}"
                id="exampleInputEmail1" placeholder="date1">
                <input type="date" name="date2" style="display: none" class="form-control" value="{{ $d2 }}"
                            id="exampleInputEmail1" placeholder="date1">
                <button type="submit" class="export-pdf btn btn-primary">
                    Export Pdf
                </button>
