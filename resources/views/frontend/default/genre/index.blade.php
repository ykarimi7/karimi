        ...
        <div class="container">
            <div class="page-header tag-header small desktop">
                <div class="inner">
                    ...
                    <h1><span title="{!! $genre->name !!}">{!! $genre->name !!}</span></h1>
                    <div class="byline"><a href="{{ route('frontend.discover') }}"><span data-translate-text="SEE_ALL_GENRES">{{ __('web.SEE_ALL_GENRES') }}</span></a></div>
                </div>
            </div>
