                ...
                <div class="content">
                    @if(count($result->artists))
                        <div class="sub-header">
                            <h2 id="search-type-header" data-translate-text="ARTIST_SEARCH_MATCHES">Artist Matches</h2>
                        </div>
                            ...
                            <div class="grid-toolbar">
                                <div class="grid-toolbar-inner">
                                    ...
                                    <ul class="actions secondary">
                                        <li>
                                            <a class="btn sort-button" data-sort-relevance="true" data-sort-artist="true">
                        ...
                        <div id="grid" class="artists medium items-sort-able">
                            @include('commons.artist', ['artists' => $result->artists, 'element' => 'search'])
                        </div>
                    @else
                        <div class="sub-header">
                            <h2 id="search-no-match-header" data-translate-text="NO_ARTIST_MATCHES">No Artist Matches</h2>
                        </div>
