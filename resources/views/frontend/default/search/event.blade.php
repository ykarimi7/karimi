                ...
                <div class="content">
                    @if(count($result->events))
                        <div class="sub-header">
                            <h2 id="search-type-header" data-translate-text="EVENT_SEARCH_MATCHES">{{ __('EVENT_SEARCH_MATCHES') }}</h2>
                        </div>
                            ...
                            <div class="grid-toolbar">
                                <div class="grid-toolbar-inner">
                                    ...
                                    <ul class="actions secondary">
                                        <li>
                                            <a class="btn sort-button" data-sort-relevance="true" data-sort-event="true">
                    ...
                    @else
                        <div class="sub-header">
                            <h2 id="search-no-match-header" data-translate-text="NO_EVENT_MATCHES">{{ __('web.NO_EVENT_MATCHES') }}</h2>
                        </div>
