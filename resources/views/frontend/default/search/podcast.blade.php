...
@section('content')
    ...
    <div id="page-content" class="search">
        <div class="container">
            ...
            <div id="column1">
                <div class="content">
                    @if(count($result->podcasts))
                        <div class="sub-header">
                            <h2 id="search-type-header" data-translate-text="PODCAST_SEARCH_MATCHES">{{ __('web.PODCAST_SEARCH_MATCHES') }}</h2>
                        </div>
                            ...
                            <div class="grid-toolbar">
                                <div class="grid-toolbar-inner">
                                    ...
                                    <ul class="actions secondary">
                                        <li>
                                            <a class="btn sort-button" data-sort-relevance="true" data-sort-album="true">
                        ...
                        <div id="grid" class="podcasts medium items-sort-able">
                            @include('commons.podcast', ['podcasts' => $result->podcasts, 'element' => 'search'])
                        </div>
                    @else
                        <div class="sub-header">
                            <h2 id="search-no-match-header" data-translate-text="NO_ALBUM_MATCHES">No Album Matches</h2>
                        </div>
