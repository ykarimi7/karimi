                ...
                <div class="content">
                    @if(count($result->users))
                        <div class="sub-header">
                            <h2 id="search-type-header" data-translate-text="STATION_SEARCH_MATCHES">User Matches</h2>
                        </div>
                            ...
                            <div class="grid-toolbar">
                                <div class="grid-toolbar-inner">
                                    ...
                                    <ul class="actions secondary">
                                        <li>
                                            <a class="btn sort-button" data-sort-relevance="true" data-sort-user="true">
                    ...
                    @else
                        <div class="sub-header">
                            <h2 id="search-no-match-header" data-translate-text="NO_PLAYLIST_MATCHES">No User Matches</h2>
                        </div>
