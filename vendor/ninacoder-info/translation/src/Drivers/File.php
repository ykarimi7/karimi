...
namespace NiNaCoder\Translation\Drivers;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Arr;
use Illuminate\Support\Collection;
use Illuminate\Support\Str;
use NiNaCoder\Translation\Exceptions\LanguageExistsException;
...
class File extends Translation implements DriverInterface
{
    ...
    {
        if ($this->languageExists($language)) {
            $this->disk->deleteDirectory("{$this->languageFilesPath}".DIRECTORY_SEPARATOR."$language");
        }
    }
